...
/* $Id: cpu6280int.h,v 1.1 2005/01/11 03:12:45 alainp Exp $ */
...
#define EVAL_FLAGNZ(context, data) (context)->flags &= (unsigned char)(~(FLAG_N|FLAG_Z)); if (!(data)) { (context)->flags |= (unsigned char)FLAG_Z; } (context)->flags |= (unsigned char)((data) & FLAG_N)
#define GET_FLAGS(context) (context)->flags
#define SET_FLAGS(context, data) (context)->flags = (unsigned char)(data)
...
#else
#define EVAL_FLAGNZ(context, data) (context)->flag_n = (unsigned char)data; (context)->flag_z = (unsigned char)data
...
/*
 * $Log: cpu6280int.h,v $
 * Revision 1.1  2005/01/11 03:12:45  alainp
 * no message
 *
